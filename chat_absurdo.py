...
class ChatWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        top_layout.addWidget(self._labeled_widget("CONTA", self.account_combo))

        self.refresh_accounts_button = QtWidgets.QPushButton("⟳  Atualizar")
        self.refresh_accounts_button.setToolTip("Recarregar contas dos JSONs")
        self.refresh_accounts_button.clicked.connect(self.load_accounts_into_selector)
        top_layout.addWidget(self.refresh_accounts_button)
        ...
        top_layout.addWidget(self._labeled_widget("MODELO", self.model_combo))
        ...
        top_layout.addLayout(badges_col)
        ...
        self.attach_button = QtWidgets.QPushButton("📎  Anexar")
        self.attach_button.setObjectName("attachButton")
        self.attach_button.setFixedHeight(38)
        ...
        hint.setStyleSheet(f"color: {C_TEXT_DIM}; font-size: 7pt;")
